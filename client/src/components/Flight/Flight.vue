...
export default {
    ...
    methods: {
        getFlight() {
            http
                .get(process.env.BACKEND_URL+'/api/flight')
                .then(response => {
        ...
        getAirplane() {
            http
                .get(process.env.BACKEND_URL+"/api/airplane")
                .then(response => {
        ...
        deleteFlight(id) {
            http
                .delete(process.env.BACKEND_URL+"/api/flight/id/" + id).then(res => {
        ...
        saveFlight() {
            http({
                    method: 'post',
                    url: process.env.BACKEND_URL+"/api/flight/create",
                    data: {
