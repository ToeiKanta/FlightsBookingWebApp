...
export default {
    ...
    methods: {
        ...
        saveBaggage() {
            http
                .post(
                    process.env.BACKEND_URL+"/api/adds-on/" +
                    this.form.maxWeight +
                    "/" +
                    this.form.price +
                    "/" +
        ...
        deleteBag(id) {
            http.delete(process.env.BACKEND_URL+"/api/adds-on/" + id).then(res => {
                console.log(res.data);
                this.getBaggage();
        ...
        getBaggagetype() {
            http
                .get(process.env.BACKEND_URL+"/api/baggage-type/")
                .then(bag => {
        ...
        getBaggage() {
            http
                .get(
                    process.env.BACKEND_URL+"/api/adds-on/airport/" + this.filterAirportId
                )
                .then(res => {
        ...
        getImage() {
            http
                .get(process.env.BACKEND_URL+"/api/baggage-image")
                .then(bimage => {
        ...
        getAirport() {
            http
                .get(process.env.BACKEND_URL+"/api/airport")
                .then(aerodrom => {
